...
/**
 * Changes case of selected letters to lower case.
...
public class ToLowerAction extends LocalizableAction {
	...
	/**
	 * Creates new {@link ToLowerAction}
	 * @param key action name
	 * @param keyDes action description
	 * @param lp {@link LocalizationProvider} 
	 * @param tabbedPane pane containing all tabs.
	 */
	public ToLowerAction(String key, String keyDes, ILocalizationProvider lp, JTabbedPane tabbedPane) {
		super(key, keyDes, lp);
